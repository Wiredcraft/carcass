...
module.exports = {
    /**
     * Plugins for the Eson parser. Note that you need to re-run `#config()`
     *   after changing the plugins.
     */
    esonPlugins: accessor('_esonPlugins', {
        getDefault: function() {
            return [eson.bools];
        }
    }),
 ...
 */
function source() {
    this._config.source.apply(this._config, arguments);
    return this;
}
