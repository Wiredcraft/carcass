...
describe('Factories / Express', function() {
    ...
    describe('options / args', function() {
        ...
        it('should can continue to run if arg is null',function(done){
            var builer = carcass.factories.Express(null);
            builer();
            done();
        });
        
        it('should can continue to run if options is null',function(done){
            var builer = carcass.factories.Express();
            builer(null);
            done();
        });
